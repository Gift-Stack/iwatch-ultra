...
Command: npx gltfjsx@6.2.13 models/scene.glb 
...
export function IWatchUltra(props: GroupProps) {
  const { nodes, materials } = useGLTF("/models/scene.glb");

  console.log("objecthdhjsk", materials.zWSbkmvYqArUSOM);
  return (
    <group {...props} dispose={null} position={[0, -4, 0]}>
      <group scale={0.5}>
        ...
        />
        <mesh
          geometry={nodes.yFPJxjHCZaMTTSP.geometry}
          material={materials.PwlvrZKCtsfdXgk}
        />
        <mesh
